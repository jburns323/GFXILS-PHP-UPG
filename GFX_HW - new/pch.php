...
class PCH {
	...
	public $Columns_Unique = array('PCH_SN'=>'PCH_SN');
	public $Columns = array('PCH_Stepping'=>'PCH_Stepping', 'Board_SN'=>'Board_SN', 'SPI'=>'SPI', 'Location'=>'Location', 'Comments'=>'PCH_Comments');

	public $DisplayColumns_Unique = array('PCH_SN'=>'PCH_SN');
	public $DisplayColumns = array('PCH_Stepping'=>'PCH_Stepping', 'Board_SN'=>'Board_SN', 'SPI'=>'SPI', 'Location'=>'Location', 'Comments'=>'PCH_Comments');

	// Column Types
	public $Column_Types = array();

	// Required Columns
	public $Columns_Required = array('PCH_SN', 'Location');

	public $Columns_Foreign = array('Location'=>'location:Location', 'Board_SN'=>'board_info:Board_SN');

	// These will be dropdown lists of values currently in the table
	public $Columns_List = array('PCH_Stepping', 'Board_SN', 'SPI', 'Location');

	// These will be freeform textarea inputs instead of one-line text fields
	public $Columns_Text = array('PCH_Comments');
