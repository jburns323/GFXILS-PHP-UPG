...
class Memory {
	...
	public $Columns_Unique = array('Memory_SN'=>'Memory_SN');
	public $Columns = array('Vendor'=>'Vendor', 'Memory_Size'=>'Memory_Size', 'Memory_Speed'=>'Memory_Speed', 'Memory_DDR'=>'Memory_DDR', 'Location'=>'Location', 'Comments'=>'Memory_Comments');

	public $DisplayColumns_Unique = array('Memory_SN'=>'Memory_SN');
	public $DisplayColumns = array('Vendor'=>'Vendor', 'Memory_Size'=>'Memory_Size', 'Memory_Speed'=>'Memory_Speed', 'Memory_DDR'=>'Memory_DDR', 'Location'=>'Location', 'Comments'=>'Memory_Comments');

	// Column Types
	public $Column_Types = array('Memory_SN'=>PDO::PARAM_INT);

	// Required Columns
	public $Columns_Required = array('Memory_SN', 'Location');

	public $Columns_Foreign = array('Location'=>'location:Location');

	// These will be dropdown lists of values currently in the table
	public $Columns_List = array('Vendor', 'Memory_Size', 'Memory_Speed', 'Memory_DDR', 'Location');

	// These will be freeform textarea inputs instead of one-line text fields
	public $Columns_Text = array('Memory_Comments');
