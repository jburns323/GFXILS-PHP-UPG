...
//$db_host = "sogfxdbg02.amr.corp.intel.com:3306";
//$db_host = "solscats01.so.intel.com:3306";
//$db_host = "anls1402.an.intel.com:3306";
$db_host = "anls1489.an.intel.com:3306";
// Database name:
//$db_database = "labbs";
$db_database = "gfxlabman";
// Database login user name:
//$db_login = "root";
$db_login = "gfxlabman";
// Database login password:
//$db_password = "gr@ph1c$";
$db_password = "gfxlabman";
...
$maxlength['room.description'] = 100;  // characters   (description field in room table)
 ...
 *********************************/
$mrbs_admin = "Shirley Arnold";
$mrbs_admin_email = "shirley.p.arnold@intel.com";
...
$mrbs_company = "Intel Corp";   // This line must always be uncommented ($mrbs_company is used in various places)

// Uncomment this next line to use a logo instead of text for your organisation in the header
//$mrbs_company_logo = "Intel Logo.gif";    // name of your logo file.   This example assumes it is in the MRBS directory

// Uncomment this next line for supplementary information after your company name or logo
$mrbs_company_more_info = "GFX SV";  // e.g. "XYZ Department"

// Uncomment this next line to have a link to your organisation in the header
//$mrbs_company_url = "http://moss.amr.ith.intel.com/sites/PVE3/GFXSV/Wiki/Home.aspx";
...
//$auth["admin"][] = "autoclient";

// 'auth_config' user database
// Format: $auth["user"]["name"] = "password";
//$auth["user"]["administrator"] = "secret";
//$auth["user"]["ivytools"] = "guest";
//$auth["user"]["jluck"] = "jdawg";
//$auth["user"]["autoclient"] = "gr@ph1c$";

//****************************************************************************************
// 'auth_ldap' configuration settings
// Where is the LDAP server
//$ldap_host[] = "ger.corp.intel.com";
$ldap_host = "corp.intel.com";
...
$ldap_base_dn[] = "OU=Workers,DC=ger,DC=corp,DC=intel,DC=com";
$ldap_base_dn[] = "OU=Workers,DC=gar,DC=corp,DC=intel,DC=com";
$ldap_base_dn[] = "OU=Workers,DC=amr,DC=corp,DC=intel,DC=com";
$ldap_base_dn[] = "OU=Service-Accounts,OU=Engineering Computing,OU=Resources,DC=amr,DC=corp,DC=intel,DC=com";
//$ldap_base_dn[] = "OU=Workers,DC=ger,DC=corp,DC=intel,DC=com";
...
$ldap_dn_search_dn = "CN=ecsys_so_gfxlabman,OU=Service-Accounts,OU=Engineering Computing,OU=Resources,DC=amr,DC=corp,DC=intel,DC=com";
$ldap_dn_search_password = "Gf*1abman";
//$ldap_dn_search_dn = "CN=autoclient,OU=Service-Accounts,OU=Engineering Computing,OU=Resources,DC=amr,DC=corp,DC=intel,DC=com";
//$ldap_dn_search_password = "gr@ph1c$";
...
$mail_settings['domain'] = 'intel.com';
...
$mail_settings['from'] = 'shirley.p.arnold@intel.com';

// Set the recipient email. Default is 'admin_email@your.org'. You can define
// more than one recipient like this "john@doe.com,scott@tiger.com"
$mail_settings['recipients'] = 'shirley.p.arnold@intel.com';
