...
if (sql_count($res) == 0)
{
  ...
  echo( '<a href="file://amr/ec/proj/so/proj/GFX_Exec3/xfer/BroxtonP/Execution/BroxtonP_System_Info.xlsx"> This is the link to Systems_Info (\\amr\ec\proj\so\proj\GFX_Exec3\xfer\BroxtonP\Execution ) </a>' );
  sql_free($res);
}
else
{
